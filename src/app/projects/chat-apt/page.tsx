                ...
                <section className="space-y-10">
                    ...
                    >
                        ...
                        <motion.div
                            ...
                            className="self-start ml-2 max-w-[90%] md:max-w-[65%] lg:max-w-[60%] bg-[#0f172a] border border-white/10 text-gray-200 px-4 py-3 rounded-2xl rounded-bl-sm"
                        >
                            “Looking for a 1BR near a gym and grocery store. Walkable preferred.”
                        </motion.div>

                        <motion.div
                            whileHover={{ scale: 1.015 }}
                            variants={{ hidden: { opacity: 0, y: 20 }, visible: { opacity: 1, y: 0 } }}
                            className="self-end mr-2 max-w-[90%] md:max-w-[65%] lg:max-w-[60%] bg-[#2563eb] text-white px-4 py-3 rounded-2xl rounded-br-sm shadow-md shadow-blue-800/20"
                        >
                            Got it. Here are listings near local gyms, with a grocery store within 5 minutes.
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="self-start ml-2 max-w-[90%] md:max-w-[65%] lg:max-w-[60%] bg-[#0f172a] border border-white/10 text-gray-200 px-4 py-3 rounded-2xl rounded-bl-sm"
                        >
                            “Dog-friendly. Close to the Red Line. Not too loud.”
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="self-end mr-2 max-w-[90%] md:max-w-[65%] lg:max-w-[60%] bg-[#2563eb] text-white px-4 py-3 rounded-2xl rounded-br-sm shadow-md shadow-blue-800/20"
                        >
                            Filtered for dog-friendly spots within 10 minutes of the Red Line — all in quieter blocks.
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="self-start ml-2 max-w-[90%] md:max-w-[65%] lg:max-w-[60%] bg-[#0f172a] border border-white/10 text-gray-200 px-4 py-3 rounded-2xl rounded-bl-sm"
                        >
                            “Remote work vibes. Natural light. Budget under $2,500.”
                        </motion.div>
                        ...
                        <motion.div
                            ...
                            className="self-end mr-2 max-w-[90%] md:max-w-[65%] lg:max-w-[60%] bg-[#2563eb] text-white px-4 py-3 rounded-2xl rounded-br-sm shadow-md shadow-blue-800/20"
                        >
                            Sorted by price, with big windows and quiet surroundings perfect for WFH.
                        </motion.div>
                    </motion.div>
                </section>
